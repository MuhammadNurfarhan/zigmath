<x-filament-panels::page>
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-700">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <p class="font-medium {{ $record->isOverdue() ? 'text-red-600' : 'text-gray-900 dark:text-white' }}">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-700">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <p class="font-medium text-gray-900 dark:text-white">{{ $record->student->package->name ?? '-' }}</p>
                </div>
                <div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-700">
            <h3 class="text-lg font-semibold mb-4 text-gray-900 dark:text-white">💰 Riwayat Pembayaran ({{ $record->payments->count() }}x)</h3>
            <div class="space-y-3">
