...
<x-filament-panels::page>
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-700">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-emerald-600">Rp {{ number_format($record->amount, 0, ',', '.') }}
                    </p>
                </div>
                <div>
                    <p class="text-sm text-gray-500">Tanggal Pembayaran</p>
                    <p class="font-medium text-gray-900 dark:text-white">
                        {{ $record->paid_at->format('d F Y, H:i') }} WIB
                    </p>
                </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-700">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p class="font-medium text-gray-900 dark:text-white">
                            {{ $record->invoice->student->parent_name }}</p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-500">No HP</p>
                        <p class="font-medium text-gray-900 dark:text-white">
                            {{ $record->invoice->student->parent_phone }}</p>
                    </div>
                    <div>
        ...
        <div class="flex flex-wrap items-center gap-3">
            <x-filament::button color="primary" tag="a" icon="heroicon-m-pencil-square" :href="PaymentResource::getUrl('edit', ['record' => $record])">
                Edit Pembayaran
            </x-filament::button>

            <x-filament::button color="gray" tag="a" icon="heroicon-m-arrow-left" :href="PaymentResource::getUrl('index')">
                Kembali
            </x-filament::button>
        </div>
    </div>
